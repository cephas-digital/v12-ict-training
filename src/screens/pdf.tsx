    ...
    <div ref={ref} className="">
      <div className="w-full relative">
        <div className="">
          ...
          <h4 className="text-xl font-bold my-4 text-da-blue-600 uppercase">
            Overview
          </h4>
          <WhiteBox2 className="w-full">
            <div
              className="
                    text-sm font-normal text-da-blue-600
                    "
              dangerouslySetInnerHTML={createMarkup(currentTool?.description)}
            />
          </WhiteBox2>
          <h4 className="text-base font-bold my-5 text-da-blue-600">
            THE CLASSIFICATION BELOW DETAILS THE PROVISION TOOL ON EACH OF THE
            SUCCESS CRITERIA
          </h4>
          <div className="mt-2 grid-cols-3 gap-8 hidden">
            <div className="col-span-2 flex flex-col">
              <WhiteBox shadow={true} className="h-full">
