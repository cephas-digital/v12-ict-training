...
const connectData = [
  {
    ...
    email: "support@ictsolutions.com",
    phone: "+1 (555) 123-4567",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    email: "partners@ictsolutions.com",
